        ...
        {localStorage.getItem("role") === "admin" ? (
          <List>
            ...
            {currentPath === "/history" ? (
              <ListItem
                key="History"
                onClick={() => this.handleSideBar("/history")}
                sx={{ backgroundColor: "#ffffff" }}
              >
                <DivStyleActive>
                  <ListItemIcon>
                    <HistoryRoundedIcon sx={{ color: "#03AC0E" }} />
                  </ListItemIcon>
                  <ListItemText>
                    <Typography
                      sx={{
              ...
              >
                <DivStyle>
                  <ListItemIcon>
                    <HistoryRoundedIcon sx={{ color: "#000000" }} />
                  </ListItemIcon>
                  <ListItemText>
                    <Typography
                      sx={{
            ...
            <ListItem
              ...
              sx={{ backgroundColor: "#ffffff", mt: 13 }}
            >
          ...
          <List>
            ...
            <ListItem
              key="Logout"
              onClick={() => this.handleLogout()}
              sx={{ backgroundColor: "#ffffff", mt: 23 }}
            >
              <DivStyle style={{ marginBottom: 0 }}>
                <ListItemIcon>
                  <LogoutIcon sx={{ color: "#000000" }} />
